      ...
      <div className="relative mt-6 mb-4 flex h-px place-items-center bg-gray-200">
        ...
        <div>
            ...
            <div className="relative">
              <Input identifier={'username'} value={values.username} handleChange={handleChange} handleBlur={handleBlur} inputType={'text'} />
              { errors.username&&touched.username?<ShowError Error={errors.username} />:null }
            </div>
          </div>
        <div>
          ...
          <div>
            <label htmlFor="confirmPassword" className="mb-2 block text-sm text-gray-600">Confirm Password</label>
            <div className="relative">
            <Input identifier={'confirmPassword'} value={values.confirmPassword} handleChange={handleChange} handleBlur={handleBlur} inputType={'password'} />
              { errors.confirmPassword&&touched.confirmPassword?<ShowError Error={errors.confirmPassword} />:null}
            </div>
          </div>
          <div class="flex items-start ">
                      ...
                      <div className="ml-3 text-xs mb-4">
                        <label for="terms" className="font-light text-gray-500 dark:text-gray-300">I accept the <Link to='termsAndConditions' className="font-medium text-primary-900 hover:underline dark:text-primary-400">Terms and Conditions</Link></label>
                      </div>
                  </div>
                  {errors.terms&&touched.terms?<p className=" relative bottom-3 ml-0 text-left  text-xs text-rose-600 " >{errors.terms}</p>:null}
