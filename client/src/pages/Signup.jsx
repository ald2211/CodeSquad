...
const Signup = () => {
  ...
  const { handleChange, handleBlur, values, errors, handleSubmit, touched,isSubmitting } =
    useFormik({
      initialValues,
    ...
    <>
      ...
      <div className="  p-3  max-w-lg mx-auto  my-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-1">
          ...
          <button
            type="submit"
            className={`w-full rounded-lg bg-blue-500 p-2 text-center text-sm font-semibold text-white shadow-md ring-gray-500 ring-offset-2 transition focus:ring-2 hover:bg-blue-700 ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
