                      ...
                      {userData.map((user, key) => (
                        <tr key={user._id}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <p onClick={() => openDeleteModal(user._id, user.userState, key)} className={`ml-2 ${user.userState ? ' text-red-600 hover:text-red-900' : 'text-blue-600 hover:text-blue-900'} pl-2 cursor-pointer`}>
                              {user.userState ? 'Block' : 'Unblock'}
                            </p>
                          </td>
                        </tr>
                      ))}
