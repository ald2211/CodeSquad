...
class experienceService{
    ...
    async getAllUserExperience(userId) {
      ...
      async editUserExperience(userId, expId, experienceData) {
        const existingExperience = await experienceRepository.findByIdAndUserId(expId, userId);
      ...
      async deleteUserExperience(userId, expId) {
        const experienceToRemove = await experienceRepository.deleteByIdAndUserId(expId, userId);
