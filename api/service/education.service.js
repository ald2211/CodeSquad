...
class educationService {
  ...
  async addUserEducation(userId, educationData) {
    const { courseName, collegeName, country, startDate, endDate } =
      educationData;
  ...
  async editUserEducation(userId, eduId, educationData) {
    const existEducation = await educationRepository.findByIdAndUserId(
      eduId,
      userId
    );
  ...
  async deleteUserEducation(userId, eduId) {
    const educationToRemove = await educationRepository.deleteByIdAndUserId(
      eduId,
      userId
    );
