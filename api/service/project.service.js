...
class projectService{
    ...
    async getAllUserProjects(userId) {
      ...
      async editUserProject(userId, projId, projectData) {
        const existingProject = await projectRepository.findByIdAndUserId(projId, userId);
      ...
      async deleteUserProject(userId, projId) {
        const projectToRemove = await projectRepository.deleteByIdAndUserId(projId, userId);
